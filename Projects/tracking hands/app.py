    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                # Преобразование в относительные / нормализованные координаты
                ...
                if hand_sign_id == 2:  # Точечный жест
                    point_history.append(landmark_list[8])  # Разница в лице относится к координатам
                else:
                    point_history.append([0, 0])

                # Классификация жестов пальцами
                finger_gesture_id = 0
                ...
                # Вычисляет идентификаторы жестов в последнем обнаружении
